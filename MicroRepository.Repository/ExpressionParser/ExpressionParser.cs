...
namespace MicroRepository.Repository
{
    ...
    internal static class ExpressionParser
    {
        internal static void ParseExpression(Expression body, ref List<QueryParameter> queryProperties)
        {
            var visitor = new SqlExpressionVisitor();
            visitor.Visit(body);
            queryProperties.AddRange(visitor.GetParameters());
        }
    }
    ...
    {
        public string? LinkingOperator { get; internal set; } = string.Empty;
        public string PropertyName { get; internal set; } = string.Empty;
        public object? PropertyValue { get; internal set; }
        public string QueryOperator { get; internal set; } = string.Empty;
        public string PropertyFormat { get; internal set; } = string.Empty;
